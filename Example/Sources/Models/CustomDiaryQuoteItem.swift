...
struct CustomDiaryQuoteItem: DiaryQuoteItem {
...
//        self.size = CGSize(width: maxBubbleWidth, height: imageHeight + height.rounded(.up) + bottomHeight.rounded(.up) + 100)
        self.size = CGSize(width: maxBubbleWidth, height: 428)
